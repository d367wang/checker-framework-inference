...
public class MethodSlotManager {
    ...
    public MethodSlotManager() {
        PURE_METHOD_SLOT = new ConstMethodSlot("pure");
        IMPURE_METHOD_SLOT = new ConstMethodSlot("impure");
    }
    ...
    public MethodSlot addNewMethodSlot(AnnotatedTypeFactory typeFactory, MethodTree node) {
        MethodSlot methodSlot = MethodSlot.create(typeFactory, node);
